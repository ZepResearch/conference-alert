...
export default function CitySearchPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-purple-50/10 relative overflow-hidde pt-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <Select onValueChange={setSelectedType}>
                    <SelectTrigger className="h-12  shadow w-full border-1 bg-white focus:bg-white transition-all duration-300 rounded-xl text-base focus:ring-2 focus:ring-blue-500/20">
        ...
        {loading ? (
          ...
          >
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-white/30 p-12 max-w-md mx-auto">
              ...
              <h4 className="text-xl font-medium text-gray-900 mb-3">No events found in {cityName}</h4>
              <p className="text-gray-600 font-light mb-6">Try browsing events in other cities or check back later</p>
              <Link href="/">
