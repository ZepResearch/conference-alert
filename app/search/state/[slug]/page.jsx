    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Conferences in {stateName}</h1>
        ...
        {loading ? (
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No events found in {stateName}</h3>
              <p className="text-gray-600 mb-4">Try browsing events in other states or check back later</p>
              <Link href="/">
