...
import { Search, Globe, ArrowLeft, Sparkles } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-purple-50/10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 font-light">Find conferences in major cities worldwide</p>
        </motion.div>
                    ...
                    <div className="p-6 text-center">
                      ...
                      <div className="flex items-center justify-center text-sm text-gray-600 mb-4">
                        <div className="w-6 h-6 bg-gray-100 rounded-lg flex items-center justify-center mr-2 group-hover:bg-blue-100 transition-colors duration-300">
                          <Globe className="h-3 w-3 text-gray-500 group-hover:text-blue-600 transition-colors duration-300" />
                        </div>
        ...
        {filteredCities.length === 0 && (
          ...
          >
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl border border-white/30 p-12 max-w-md mx-auto">
              ...
              <p className="text-gray-600 font-light mb-6">Try adjusting your search criteria</p>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
        ...
        {filteredCities.length > 0 && (
          ...
          >
            {[
              ...
              { number: "5000+", label: "Global Events" },
            ].map((stat, index) => (
              <motion.div
                key={index}
